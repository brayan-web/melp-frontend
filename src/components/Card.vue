    ...
    >
      ...
      <div class="p-6">
        <div class="flex items-center justify-between mb-3">
          ...
          >
            Barajas, Bahena and Kano
          </h5>
        </div>
        <p
          class="block font-sans text-base antialiased font-light leading-relaxed text-gray-300"
        ></p>
        <div
...
<span class="ml-2 text-md">Mariano Entrada, Mérida Alfredotown, Durango</span>
...
<span class="ml-2 text-md">534 814 204</span>
